// Ícones SVG minimalistas para a aplicação
...
export function WhatsAppIcon({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.67-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.076 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421-7.403h-.004a9.87 9.87 0 00-4.773 1.149c-1.466.746-2.723 1.780-3.656 3.071-2.236 2.962-2.722 7.357-.882 10.715.934 1.709 2.382 3.175 4.041 4.235 2.51 1.6 5.662 2.538 8.83 2.538 7.616 0 13.8-6.184 13.8-13.8 0-3.495-1.389-6.773-3.931-9.315-2.537-2.537-5.9-3.931-9.315-3.931" />
    </svg>
  );
}
...
export function InstagramIcon({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
      <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0m5.521 11.677c.002.344.003.682.003 1.023 0 3.169-2.412 6.83-6.831 6.83-1.356 0-2.616-.397-3.68-1.08.188.022.379.033.572.033 1.123 0 2.156-.383 2.976-1.028-.948-.022-1.771-.644-2.05-1.509.132.025.267.038.406.038.218 0 .43-.029.632-.085-1.02-.206-1.787-1.106-1.787-2.188 0-.009 0-.019 0-.028.301.167.646.267 1.015.279-.599-.401-1.004-1.089-1.004-1.868 0-.411.111-.797.305-1.128 1.099 1.348 2.747 2.237 4.604 2.33-.038-.163-.058-.331-.058-.502 0-1.217.987-2.204 2.204-2.204.634 0 1.207.268 1.609.697.502-.099.975-.283 1.403-.537-.165.514-.514.946-.968 1.219.446-.053.87-.171 1.265-.347-.296.441-.67.831-1.099 1.143z" />
    </svg>
  );
}

export function BibleIcon({ size = 20, className }: IconProps) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M4 19.5A2.5 2.5 0 0 1 6.5 17H20" /><path d="M6.5 2H20v20H6.5A2.5 2.5 0 0 1 4 19.5v-15A2.5 2.5 0 0 1 6.5 2z" /><line x1="12" y1="7" x2="12" y2="17" /><line x1="8" y1="10" x2="16" y2="10" />
    </svg>
  );
}
